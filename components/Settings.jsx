      ...
      >
        <View style={styles.avatarContainer}>
          <View style={styles.userAvatar}>
            <Image
              source={{
                uri: "https://www.1zoom.me/big2/946/289597-frederika.jpg",
              }}
              style={{ flex: 1, borderRadius: 75, resizeMode: "center" }}
            />
          </View>
          <Text style={styles.userName}>{"Subhransu Bidyasagar Kandi"}</Text>
        </View>
        <View style={styles.quoteContainer}>
          ...
          >
            " {"Daily inspirational quote will appear here"} "
          </Text>
        </View>
